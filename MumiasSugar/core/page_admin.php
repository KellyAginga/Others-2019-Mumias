<?php 
	...
	function as_navigation($request, $html = '')
	{
		...
		$navigation = array();
		if ( $managerid ) {			
			$navigation['farmers'] = array('label' => 'Farmers', 'url' => 'manager.php?open=farmer_all');
			$navigation['appointments'] = array('label' => 'Appointments', 'url' => 'manager.php?open=appointment_all');
			$navigation['transporters'] = array('label' => 'Transporters', 'url' => 'manager.php?open=transporter_all');
			$navigation['managers'] = array('label' => 'Managers', 'url' => 'manager.php?open=manager_all');
			$navigation['settings'] = array('label' => 'Settings', 'url' => 'manager.php?open=settings');			
			$navigation['signout'] = array('label' => 'Sign Out?', 'url' => 'manager.php?open=signout');
		} else {
			$navigation['signin'] = array('label' => 'Sign In', 'url' => 'manager.php?open=signin');
			$navigation['register'] = array('label' => 'SignUp', 'url' => 'manager.php?open=register');
		}			
	...
	<h2>
			...
			case 'table': ?>
				...
				<th><?php echo $header ?></th>
					...
					<?php foreach($page['items'] as $rid => $trow) { ?>
						<tr onclick="location='manager.php?<?php echo $page['onclick'].$rid ?>'">
		...
		<?php break;
			...
			<?php foreach($page['items'] as $item) { ?>
				<div title="<?php echo $item[6] ?>"><a href="manager.php?open=job_view&&jobid=<?php echo $item[0] ?>"><h3><?php echo $item[1] ?></h3></a>
				<p>
